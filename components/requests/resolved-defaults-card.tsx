 ...
 * resolved.
 */
export function ResolvedDefaultsCard({ audience, objective, tone, cta }: ResolvedDefaultsCardProps) {
  const rows = [
    ...
    { label: "CTA", value: cta || "None unless specified" },
    { label: "Primary keyword", value: "Will be derived during research" },
  ];
